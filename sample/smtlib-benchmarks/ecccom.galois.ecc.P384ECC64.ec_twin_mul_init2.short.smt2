...
(assert (= x156 ((_ extract 383 0) x97)))
...
(assert (= x151 ((_ extract 383 0) x105)))
...
(assert (= x134 ((_ extract 383 0) x105)))
...
(assert (= x127 ((_ extract 383 0) x97)))
(assert (= x126 ((_ extract 383 0) x105)))
...
(assert (= x113 ((_ extract 383 0) x97)))
...
(assert (= x106 ((_ extract 383 0) x105)))
...
(assert (= x98 ((_ extract 383 0) x97)))
